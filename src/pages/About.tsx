...
const About = () => {
  useSEO({
    ...
    jsonLd: {
      ...
      "@type": "AboutPage",
      name: "About Capvtal Innovations",
      url: `${SITE_URL}/about`,
      mainEntity: {
        "@type": "Organization",
    ...
    <div className="container mx-auto px-6 py-16">
      ...
      <section className="max-w-3xl mb-20">
        ...
        <p className="text-muted-foreground leading-relaxed opacity-0 animate-fade-in" style={{ animationDelay: "0.1s" }}>
          ...
          <br /><br />
          The name <strong>Capvtal</strong> is intentionally spelled with a "V", a distinctive identity created to establish a unique brand presence and protect the originality of our vision in an increasingly competitive world. More than just a name, Capvtal represents ownership, innovation, and the pursuit of building something truly timeless.
          <br /><br />
